        ...
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <th>Status</th>
                    <th>
                        <button type="button" class="btn btn-outline btn-primary btn-circle" onclick="courseEdit();"><i class="fa fa-plus">&nbsp; Add New</i></button></th>
                </tr>
                ...
                <tr>
                    ...
                    <td>Mark</td>
                    <td>
                        <button type="button" class="btn btn-outline btn-primary btn-circle" onclick="courseEdit('1');"><i class="fa fa-pencil"></i></button>
                ...
                <tr>
                    ...
                    <td>Mark</td>
                    <td>
                        <button type="button" class="btn btn-outline btn-primary btn-circle" onclick="courseEdit('2');"><i class="fa fa-pencil"></i></button>
                        <button type="button" class="btn btn-outline btn-danger btn-circle"><i class="fa fa-trash-o"></i></button>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>Otto</td>
                    <td>
                        <button type="button" class="btn btn-outline btn-primary btn-circle" onclick="courseEdit('3');"><i class="fa fa-pencil"></i></button>
                        <button type="button" class="btn btn-outline btn-danger btn-circle"><i class="fa fa-trash-o"></i></button>
                    </td>
                </tr>
                ...
                <div class="modal-body">
                   ...
                   <div class="form-group col-lg-6">
                    ...
                    <div class="form-group col-lg-6" style="text-align: right; padding: 25px 0 0 0">
                        <div class="btn btn-default" id="btnclClear"><i class="fa fa-refresh">&nbsp;Clear</i></div>
                        <div class="btn btn-primary" onclick="test();" id="btnclClose"><i class="fa fa-times">&nbsp;Close</i></div>
